(function ($) {
    ...
    if ($('.partner-filter-btn').length) {
        //Show Form
        $('.partner-filter-btn').on('click', function (e) {
            e.preventDefault();
            $('body').addClass('partner-hidden-sidebar-content');
        });
        //Hide Form
        $('.sidebar-close-icon,.hiddenbar-body-ovelay').on('click', function (e) {
            e.preventDefault();
            $('body').removeClass('partner-hidden-sidebar-content');
        });
    }
