          ...
          <div class="row d-block d-sm-flex justify-content-center justify-content-sm-between">
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="dashboard_page_add_listing text-center text-lg-end mb30 mb15-520 d-grid">
                <a href="{{ route('admin.product.create') }}" class="btn btn-new btn-lg btn-thm">Add New Products</a>
              </div>
            </div>
          </div>
                  ...
                  <td class="editing_list align-middle">
                    <ul>
                      <li class="list-inline-item mb-1 c-btn-color ">
                        <a href="{{ route('admin.product.edit') }}" data-bs-toggle="tooltip" data-bs-placement="top"
                      ...
                      <li class="list-inline-item mb-1 c-btn-color ">
                        <a href="{{ route('admin.product.detail') }}" data-bs-toggle="tooltip" data-bs-placement="top"
