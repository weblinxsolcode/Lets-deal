...
<head>
  <meta charset="utf-8">
    ...
    <title>Happicard - Vendor | {{ @$title ?? '' }}</title>
</head>
        ...
        <div class="row">
          <div class="col-lg-6 col-xl-5 col-xxl-4 m-auto">
            <div class="log_reg_form mt70-992">
              <h2 class="title">Sign-In as Vendor</h2>
              <div class="login_form">
                <form action="{{ route('vendor.login-check') }}" method="POST">
                  @csrf
                  <div class="mb-2 mr-sm-2">
                    <label class="form-label">Email Address</label>
                    <input type="text" class="form-control" placeholder="Please Enter Your Email Address" required name="email">
                  </div>
                  <div class="form-group mb5">
                    <label class="form-label">Password</label>
                    <input type="password" class="form-control" placeholder="Please Enter Your Password" required name="password">
                  </div>
